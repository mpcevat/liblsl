...
namespace LSLExamples
{
    static class ReceiveDataInChunks
    {
        public static void Main(string[] args)
        {
            ...
            StreamInfo[] results = LSL.LSL.resolve_stream("type", "ExG");
            ...
            int num_chans = inlet.info().channel_count();                         
            int num_timestamps = buffer.Length / num_chans; 
            double[] timestamps = new double[num_timestamps];
